                ...
                <div class="row margin-vert-40">
                    ...
                    <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            ...
                            <div class="signup-header">
                                <h2 class="margin-bottom-20"><b>Register a new account</b></h2>
                                ...
                                {!! Form::open(['url' => 'users','files'=>true, 'class'=>'margin-bottom-20'])!!}
                                    ...
                                    <div class="form-group margin-bottom-20">
                                        <label for="">Profile Pic (size 255 x 170 pixels)</label>
                                ...
                                <hr>
                                    ...
                                    <div class="form-group margin-bottom-20">
                                        <label for="">About Me: (400 characteres)</label>
                                ...
                                <h3 class="margin-bottom-20"><b>Category Offering:</b></h3>
                                    ...
                                    <div class="form-group col-md-12 ">
                                      ...
                                      {!!Form::select('category_offering[]',App\Category::lists('name','id'),null,['id'=>'category_list','class'=>'form-control','multiple'=>'multiple']);!!}
                                ...
                                <h3 class="margin-bottom-20"><b>Category Seeking:</b></h3>
                                    ...
                                    <div class="form-group col-md-12 ">
                                        ...
                                        {!!Form::select('category_seeking[]',App\Category::lists('name','id'),null,['id'=>'category_list_seeking','class'=>'form-control','multiple'=>'multiple']);!!}
